	...
	private function settings_fields () {
		...
		if( $this->parent->license->is_valid() ){
			...
			$settings['license'] = array(
				'title'					=> __( 'License', 'woocommerce-product-faq-tab' ),
				'description'			=> __( '', 'woocommerce-product-faq-tab' ),
				'fields'				=> array(
					array(
						'label'			=> 'License Key',
						'id'			=> 'license_key',
			...
			$settings['license'] = array(
				'title'					=> __( 'Activate License', 'woocommerce-product-faq-tab' ),
				'description'			=> __( 'Please enter the license key for this product to activate it. You were given a license key when you purchased this item.', 'woocommerce-product-faq-tab' ),
				'fields'				=> array(
					array(
						'label'			=> 'License Key',
						'id'			=> 'license_key',
